...
//
// Questions and answers are verbatim from the source doc
// (758ab571-OOCWebsiteContentConsolidated.pdf). Inline `[PLACEHOLDER; ...]`
// markers are the source doc's own — kept literal so they surface in the UI.
...
export const certificationFaqs: FAQItem[] = [
  {
    ...
    answer:
      "Most organisations complete the journey from application to certification in [PLACEHOLDER; typical duration]. The largest variable is how quickly evidence and stakeholder inputs are completed on your side; our team supports you throughout to keep the process moving.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Fees depend on organisation size and the scope being certified. Current fee structure: [PLACEHOLDER; pricing tiers]. Your application confirmation will include an exact quotation before any commitment is required.",
  },
  {
    question: "How long does certification last?",
    answer:
      "Certification is valid for [PLACEHOLDER; validity period], with annual verification in between and a full reassessment at renewal. Organisations that improve can move up a level at reassessment.",
  },
  {
  ...
  employers: [
    {
      ...
      answer:
        "Yes. The framework scales with organisation size, and fees are size-based: [PLACEHOLDER; pricing tiers]. Smaller employers often benefit most, because certification gives them a credibility signal that usually only large employer brands enjoy.",
    },
    {
