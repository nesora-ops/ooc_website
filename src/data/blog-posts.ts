...
// Cover art is intentionally omitted for now — the previous abstract diagrams
// (public/images/blog/*.png, scripts/generate-blog-art.mjs) are being replaced
// with new imagery. Until it lands, every post leaves `image` undefined and the
// ImageSlot renders its labelled placeholder on the listing, article hero, and
